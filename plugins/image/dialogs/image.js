                            ...
                            children: [
...

                                {
                                    ...
                                    onLoad : function() {
                                        ...
                                        $.each(editor.config.internalPages.responseJSON, function(index, data) {


                                            $(elementId).get(0).options[$(elementId).get(0).options.length] = new Option(data.label, decodeURIComponent(data.url));
                                    ...
                                    onChange : function() {
                                        ...
                                        var dialog = this.getDialog();
                                        dialog.getContentElement('Link', 'txtUrl').setValue(this.getValue());
